...
?>
    ...
    <div class="container-fluid">
	  <div class="row">
		<div class="col-lg-8">
		<h1 class="my-4"></h1>
			<div class="nav flex-row nav-pills" id="v-pills-tab" style="padding: 16px;" role="tablist" aria-orientation="Horizontal">
			  <a class="nav-link active" id="v-pills-product-tab" data-toggle="pill" href="#v-pills-product" role="tab" aria-controls="v-pills-product" aria-selected="true">Product</a>
			  ...
			  <a class="nav-link" id="v-pills-seller-tab" data-toggle="pill" href="#v-pills-vendor" role="tab" aria-controls="v-pills-vendor" aria-selected="false">Seller</a>
			  ...
			  <a class="nav-link" id="v-pills-customer-tab" data-toggle="pill" href="#v-pills-customer" role="tab" aria-controls="v-pills-customer" aria-selected="false">Consumer</a>
				  ...
				  <div class="card-body">
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-product">
							<a class="nav-link active" data-toggle="tab" href="#productDetailsTab">product</a>
						</li>
						<li class="nav-product">
							<a class="nav-link" data-toggle="tab" href="#productImageTab">Upload Image</a>
						</li>
					</ul>
					
					<!-- Tab panes for product details and image sections -->
					<div class="tab-content">
						<div id="productDetailsTab" class="container-fluid tab-pane active">
							<br>
							<!-- Div to show the ajax message from validations/db submission -->
							<div id="productDetailsMessage"></div>
							<form>
							  <div class="form-row">
								<div class="form-group col-md-3" style="display:inline-block">
								  <label for="productDetailsproductNumber">product Number<span class="requiredIcon">*</span></label>
								  <input type="text" class="form-control" name="productDetailsproductNumber" id="productDetailsproductNumber" autocomplete="off">
								  <div id="productDetailsproductNumberSuggestionsDiv" class="customListDivWidth"></div>
								</div>
								<div class="form-group col-md-3">
								  <label for="productDetailsProductID">Product ID</label>
								  <input class="form-control invTooltip" type="number" readonly  id="productDetailsProductID" name="productDetailsProductID" title="This will be auto-generated when you add a new product">
								</div>
							  </div>
							  <div class="form-row">
								  <div class="form-group col-md-6">
									<label for="productDetailsproductName">product Name<span class="requiredIcon">*</span></label>
									<input type="text" class="form-control" name="productDetailsproductName" id="productDetailsproductName" autocomplete="off">
									<div id="productDetailsproductNameSuggestionsDiv" class="customListDivWidth"></div>
								  </div>
								  <div class="form-group col-md-2">
									<label for="productDetailsStatus">Status</label>
									<select id="productDetailsStatus" name="productDetailsStatus" class="form-control chosenSelect">
							  ...
							  <div class="form-row">
								<div class="form-group col-md-6" style="display:inline-block">
								  <!-- <label for="productDetailsDescription">Description</label> -->
								  <textarea rows="4" class="form-control" placeholder="Description" name="productDetailsDescription" id="productDetailsDescription"></textarea>
								</div>
							  </div>
							  <div class="form-row">
								<div class="form-group col-md-3">
								  <label for="productDetailsDiscount">Discount %</label>
								  <input type="text" class="form-control" value="0" name="productDetailsDiscount" id="productDetailsDiscount">
								</div>
								<div class="form-group col-md-3">
								  <label for="productDetailsQuantity">Quantity<span class="requiredIcon">*</span></label>
								  <input type="number" class="form-control" value="0" name="productDetailsQuantity" id="productDetailsQuantity">
								</div>
								<div class="form-group col-md-3">
								  <label for="productDetailsUnitPrice">Unit Price<span class="requiredIcon">*</span></label>
								  <input type="text" class="form-control" value="0" name="productDetailsUnitPrice" id="productDetailsUnitPrice">
								</div>
								<div class="form-group col-md-3">
								  <label for="productDetailsTotalStock">Total Stock</label>
								  <input type="text" class="form-control" name="productDetailsTotalStock" id="productDetailsTotalStock" readonly>
								</div>
								<div class="form-group col-md-3">
							  ...
							  <button type="button" id="updateproductDetailsButton" class="btn btn-primary">Update</button>
							  <button type="button" id="deleteproduct" class="btn btn-danger">Delete</button>
							  <button type="reset" class="btn" id="productClear">Clear</button>
							</form>
						</div>
						<div id="productImageTab" class="container-fluid tab-pane fade">
							<br>
							<div id="productImageMessage"></div>
							...
							<form name="imageForm" id="imageForm" method="post">
							  <div class="form-row">
								<div class="form-group col-md-3" style="display:inline-block">
								  <label for="productImageproductNumber">product Number<span class="requiredIcon">*</span></label>
								  <input type="text" class="form-control" name="productImageproductNumber" id="productImageproductNumber" autocomplete="off">
								  <div id="productImageproductNumberSuggestionsDiv" class="customListDivWidth"></div>
								</div>
								<div class="form-group col-md-4">
									<label for="productImageproductName">product Name</label>
									<input type="text" class="form-control" name="productImageproductName" id="productImageproductName" readonly>
								</div>
							  </div>
							  <br>
							  <div class="form-row">
								  <div class="form-group col-md-7">
									<label for="productImageFile">Select Image ( <span class="blueText">jpg</span>, <span class="blueText">jpeg</span>, <span class="blueText">gif</span>, <span class="blueText">png</span> only )</label>
									<input type="file" class="form-control-file btn btn-dark" id="productImageFile" name="productImageFile">
								  </div>
							  </div>
							  <br>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
					  <div class="form-row">
						<div class="form-group col-md-3">
						  <label for="purchaseDetailsproductNumber">product Number<span class="requiredIcon">*</span></label>
						  <input type="text" class="form-control" id="purchaseDetailsproductNumber" name="purchaseDetailsproductNumber" autocomplete="off">
						  <div id="purchaseDetailsproductNumberSuggestionsDiv" class="customListDivWidth"></div>
						</div>
						<div class="form-group col-md-3">
					  ...
					  <div class="form-row"> 
						  <div class="form-group col-md-4">
							<label for="purchaseDetailsproductName">product Name<span class="requiredIcon">*</span></label>
							<input type="text" class="form-control invTooltip" id="purchaseDetailsproductName" name="purchaseDetailsproductName" readonly title="This will be auto-filled when you enter the product number above">
						  </div>
						  <div class="form-group col-md-2">
						  ...
						  <div class="form-group col-md-4">
							<label for="purchaseDetailssellerName">Vendor Name<span class="requiredIcon">*</span></label>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
					  <div class="form-row">
						<div class="form-group col-md-3">
						  <label for="saleDetailsproductNumber">product Number<span class="requiredIcon">*</span></label>
						  <input type="text" class="form-control" id="saleDetailsproductNumber" name="saleDetailsproductNumber" autocomplete="off">
						  <div id="saleDetailsproductNumberSuggestionsDiv" class="customListDivWidth"></div>
						</div>
						<div class="form-group col-md-3">
					  ...
					  <div class="form-row">
						  <div class="form-group col-md-5">
							<label for="saleDetailsproductName">product Name</label>
							<!--<select id="saleDetailsproductNames" name="saleDetailsproductNames" class="form-control chosenSelect"> -->
								<?php 
									//require('model/product/getproductDetails.php');
								?>
							<!-- </select> -->
							<input type="text" class="form-control invTooltip" id="saleDetailsproductName" name="saleDetailsproductName" readonly title="This will be auto-filled when you enter the product number above">
						  </div>
						  <div class="form-group col-md-3">
			  ...
			  <div class="tab-pane fade" id="v-pills-search" role="tabpanel" aria-labelledby="v-pills-search-tab">
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-product">
							<a class="nav-link active" data-toggle="tab" href="#productSearchTab">product</a>
						</li>
						<li class="nav-product">
					...
					<!-- Tab panes -->
					<div class="tab-content">
						<div id="productSearchTab" class="container-fluid tab-pane active">
						  <br>
						  <p>Use the grid below to search all details of products</p>
						  <!-- <a href="#" class="productDetailsHover" data-toggle="popover" id="10">wwwee</a> -->
							<div class="table-responsive" id="productDetailsTableDiv"></div>
						</div>
			  ...
			  <div class="tab-pane fade" id="v-pills-reports" role="tabpanel" aria-labelledby="v-pills-reports-tab">
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-product">
							<a class="nav-link active" data-toggle="tab" href="#productReportsTab">product</a>
						</li>
						<li class="nav-product">
					...
					<div class="tab-content">
						<div id="productReportsTab" class="container-fluid tab-pane active">
							<br>
							<p>Use the grid below to get reports for products</p>
							<div class="table-responsive" id="productReportsTableDiv"></div>
						</div>
